...
async function seedDemoProducts() {
  ...
  const demo = [
    { nombre:'Sport Bra Elite', descripcion:'Bra deportivo de alto impacto, tela transpirable y soporte superior.', precio:25990, precioOriginal:34990, categoria:'tops', imagen:'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=500&auto=format', tallas:[{talla:'XS',stock:5},{talla:'S',stock:8},{talla:'M',stock:3},{talla:'L',stock:0},{talla:'XL',stock:2},{talla:'XXL',stock:0}], destacado:true, nuevo:false, activo:true },
    { nombre:'Legging Sculpt Pro', descripcion:'Legging moldeador de alta compresión con bolsillo lateral.', precio:34990, precioOriginal:0, categoria:'bottoms', imagen:'https://images.unsplash.com/photo-1506629082955-511b1aa562c8?w=500&auto=format', tallas:[{talla:'XS',stock:4},{talla:'S',stock:6},{talla:'M',stock:5},{talla:'L',stock:3},{talla:'XL',stock:1},{talla:'XXL',stock:0}], destacado:true, nuevo:true, activo:true },
    { nombre:'Conjunto Nude Power', descripcion:'Set coordinado bra + legging en tono nude, perfecto para pilates y yoga.', precio:54990, precioOriginal:69990, categoria:'conjuntos', imagen:'https://images.unsplash.com/photo-1518310383802-640c2de311b2?w=500&auto=format', tallas:[{talla:'XS',stock:2},{talla:'S',stock:4},{talla:'M',stock:4},{talla:'L',stock:2},{talla:'XL',stock:0},{talla:'XXL',stock:0}], destacado:true, nuevo:true, activo:true },
    { nombre:'Camiseta Airy Flow', descripcion:'Camiseta ultraligera de entrenamiento, secado rápido y corte holgado.', precio:18990, precioOriginal:0, categoria:'tops', imagen:'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=500&auto=format', tallas:[{talla:'XS',stock:6},{talla:'S',stock:8},{talla:'M',stock:7},{talla:'L',stock:5},{talla:'XL',stock:3},{talla:'XXL',stock:1}], destacado:false, nuevo:false, activo:true },
    { nombre:'Shorts Active Cream', descripcion:'Shorts deportivos con bolsillos y cintura elástica ajustable.', precio:21990, precioOriginal:0, categoria:'bottoms', imagen:'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=500&auto=format', tallas:[{talla:'XS',stock:3},{talla:'S',stock:5},{talla:'M',stock:4},{talla:'L',stock:2},{talla:'XL',stock:1},{talla:'XXL',stock:0}], destacado:false, nuevo:true, activo:true },
    { nombre:'Bolso Gym Boutique', descripcion:'Bolso deportivo de lona resistente con compartimiento para calzado.', precio:29990, precioOriginal:39990, categoria:'accesorios', imagen:'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=500&auto=format', tallas:[{talla:'UNICA',stock:10}], destacado:false, nuevo:false, activo:true }
  ];
