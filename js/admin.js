...
async function seedDemoProducts() {
  ...
  const demo = [
    ...
    { nombre:'Sport Bra Multicolor', descripcion:'Bra deportivo de sujeción media disponible en plateado, negro y crema. Ideal para pilates y yoga.', precio:24990, precioOriginal:32990, categoria:'tops', imagen:'img/producto-3.jpg', tallas:[{talla:'XS',stock:5},{talla:'S',stock:8},{talla:'M',stock:3},{talla:'L',stock:0},{talla:'XL',stock:2},{talla:'XXL',stock:0}], destacado:true, nuevo:false, activo:true },
